...
namespace ZYSocket.Share
{
    public class ZYNetBufferReadStream : Stream
    {
        ...
        protected void ThrowStreamClose()
        {
        ...
        public ZYNetBufferReadStream()
            : this(0, 4096, 4)
        {
        }


        public ZYNetBufferReadStream(int maxSize)
            : this(0, maxSize, 4)
        {
        }

        public ZYNetBufferReadStream(int maxSize, int headBit)
